...
class TestTFSimpleAlexnet(unittest.TestCase):
    ...
    def test_alexnet(self):
        # Training
        copy_tf_simple_alexnet.alexnet([None,32,32,3],10)
