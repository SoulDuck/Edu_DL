...
start_x = -3.
start_y = -3.
gradient_descent(start_x, start_y, 0.00005, tf_beale)
momentum(start_x, start_y, 0.00005, tf_beale)
momentum_nag(start_x, start_y, 0.00005, tf_beale)
...
gd_xs, gd_ys, gd_zs = trace(sess, 20000, 'GD')
