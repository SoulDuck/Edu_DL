...
rmps_xs, rmps_ys, rmps_zs = trace(sess, 50000, 'RMSProp')
...
ax.plot([start_x]+rmps_xs, [start_y]+rmps_ys, [start_z]+rmps_zs, label='RMSProp(lr={})'.format(rmsp_lr), color='b')
